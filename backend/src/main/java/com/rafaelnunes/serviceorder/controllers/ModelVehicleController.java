...
public class ModelVehicleController {
	...
	@PostMapping
	public ResponseEntity<ModelVehicleDTO> insert(@RequestBody ModelVehicleDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ModelVehicleDTO> insert(@PathVariable Long id, @RequestBody ModelVehicleDTO dto) {
